function [t, u] = trapezoidal_method(func, interval, eta, n, epsilon)
...
for i=1:length(t) - 1
    ...
    syms v;
    next_step = solve(v == u(i) + (1/2) * h * (func(t(i), u(i)) + func(t(i) + h, v)), v);
    
    phi = (1/2) * (func(t(i), u(i)) + func(t(i) + h, next_step));
